...
async fn handle_ldk_events(
    ...
    outbound_payments: Arc<Mutex<PaymentInfoStorage>>,
    ...
    match event {
        ...
        Event::PaymentClaimed {
            ...
            persister
                .persist(INBOUND_PAYMENTS_FNAME, &*inbound)
                .unwrap();
        }
        Event::PaymentSent {
            payment_preimage,
            ...
            persister
                .persist(OUTBOUND_PAYMENTS_FNAME, &*outbound)
                .unwrap();
        }
...
pub async fn start_ldk() {
    ...
    persister
        .persist(OUTBOUND_PAYMENTS_FNAME, &*outbound_payments.lock().unwrap())
        .unwrap();
    ...
    let (_bp_exit, bp_exit_check) = tokio::sync::watch::channel(());
    let _background_processor = tokio::spawn(process_events_async(
        Arc::clone(&persister),
        event_handler,
        chain_monitor.clone(),
