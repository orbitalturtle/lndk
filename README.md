...
To accomplish #1, follow the instructions below to get the LNDK binary up and running. Once you have LNDK up and running, you can accomplish #2 with either [the CLI](https://github.com/lndk-org/lndk/blob/master/docs/cli_commands.md) or connecting to the [gRPC API](https://github.com/lndk-org/lndk/blob/master/docs/grpc_client.md).
